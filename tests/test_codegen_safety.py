...
GENERATOR_CALLS = [
    ...
    ("extrude.symmetric", f.build_extrude, ("outer",), {"extent_kind": "symmetric", "expression": "4 mm"}),
    ("extrude.participants", f.build_extrude, ("outer",),
     {"operation": "cut", "expression": "2 mm", "participants": ["body_main"]}),
    ("fillet_by_geom.min", f.build_fillet_edges_by_geometry, ("body_main", "2 mm"), {}),
    ("fillet_by_geom.minlen", f.build_fillet_edges_by_geometry, ("body_main", "2 mm"), {"min_length_mm": 5.0}),
    ("chamfer_by_geom.min", f.build_chamfer_edges_by_geometry, ("body_main", "1 mm"), {}),
    ("chamfer_by_geom.two_dist", f.build_chamfer_edges_by_geometry, ("body_main", "1 mm"),
     {"kind": "two_dist", "distance2": "2 mm"}),
    ("chamfer_by_geom.dist_angle", f.build_chamfer_edges_by_geometry, ("body_main", "1 mm"),
    ...
    ("pattern_rect.x_only", f.build_pattern_rectangular, ("rib",),
     {"x_axis": "x", "x_count": 3, "x_distance": "30 mm"}),
    ("pattern_rect.two_dir", f.build_pattern_rectangular, ("rib",),
     {"x_axis": "x", "x_count": 3, "x_distance": "30 mm",
    ...
    ("hole.counterbore", f.build_add_hole, ("body_main", [10.0, 10.0, 0.0], "5 mm"),
     {"kind": "counterbore", "cbore_diameter": "9 mm", "cbore_depth": "3 mm"}),
    ("hole.countersink", f.build_add_hole, ("body_main", [10.0, 10.0, 0.0], "5 mm"),
     {"kind": "countersink", "csink_diameter": "9 mm", "csink_angle": "90 deg"}),
    ("hole.distance", f.build_add_hole, ("body_main", [10.0, 10.0, 0.0], "5 mm"),
     {"extent_kind": "distance", "depth_expression": "6 mm"}),
    ("move_body.translate", f.build_move_body, ("body_main",), {"translation_mm": [1.0, 2.0, 3.0]}),
    ("move_body.rotate", f.build_move_body, ("body_main",),
    ...
    ("move_component.translate", asm.build_move_component, ("Comp1",), {"translation_mm": [1.0, 2.0, 3.0]}),
    ("move_component.rotate", asm.build_move_component, ("Comp1",),
    ...
    ("create_joint.revolute", asm.build_create_joint, (HANDLE, HANDLE),
    ...
    ("add_rectangle.3pt", sk.build_add_rectangle, ("outer", "3pt", [0, 0], [10, 0]), {"p3": [10, 5]}),
    ("add_circle.cr", sk.build_add_circle, ("outer", "center_radius"), {"center": [0, 0], "radius_mm": 5}),
    ("add_polygon", sk.build_add_polygon, ("outer", 6, [0, 0], [10, 0]), {}),
    ("add_ellipse", sk.build_add_ellipse, ("outer", [0, 0], [10, 0], [0, 5]), {}),
    ("add_arc.3pt", sk.build_add_arc, ("outer", "3pt"), {"p1": [0, 0], "p2": [5, 5], "p3": [10, 0]}),
    ...
    ("dimension.min", sk.build_add_dimension,
    ...
    # ---- construction ----
    ("cplane.offset", cons.build_create_construction_plane, ("offset",),
     {"base_plane": "xy", "offset": "10 mm"}),
    ("cplane.midplane", cons.build_create_construction_plane, ("midplane",),
     {"plane_a": "xy", "plane_b": "xz"}),
    ("cplane.at_angle", cons.build_create_construction_plane, ("at_angle",),
     {"axis": "x", "base_plane": "xy", "angle": "30 deg"}),
    ("cplane.3_points", cons.build_create_construction_plane, ("3_points",),
     {"p1": [0, 0, 0], "p2": [10, 0, 0], "p3": [0, 10, 0]}),
    ("caxis.2_points", cons.build_create_construction_axis, ("2_points",),
     {"p1": [0, 0, 0], "p2": [0, 0, 10]}),
    ("caxis.normal", cons.build_create_construction_axis, ("normal_to_face_by_geometry",),
    ...
    ("list_body_entities.filtered", ht.build_list_body_entities, ("body_main",),
...
def test_generated_script_has_no_js_literals(label, fn, args, kwargs):
    ...
    if leaks:
        detail = "\n".join(
            f"    line {lineno}: {src.splitlines()[lineno - 1].strip()}"
            for _, lineno in leaks
        )
        pytest.fail(
...
def test_pattern_rectangular_two_direction_still_uses_caller_values():
    ...
    src = f.build_pattern_rectangular(
        "rib", x_axis="x", x_count=3, x_distance="30 mm",
        y_axis="y", y_count=2, y_distance="20 mm",
    )
